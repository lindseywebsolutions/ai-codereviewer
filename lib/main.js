...
const calculatePRScore = ({ linesAdded, linesDeleted, linesChanged, filesChanged }) => 0.5 * linesAdded + 0.3 * linesDeleted + 0.2 * linesChanged - 5 * filesChanged;
...
const getDiff = async (owner, repo, pull_number) => {
    try {
